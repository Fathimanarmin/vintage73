...
export default function ReceiptVoucher() {
    ...
    const handleEdit = (v) => {
        ...
        setFormData({
            ...
            receiptAccount: debitEntry?.ledgerId || debitEntry?.debitLedgerId || '',
            incomeAccount: creditEntry?.ledgerId || creditEntry?.creditLedgerId || '',
                    ...
                    <div className="bg-white rounded-xl shadow-md border border-slate-200">
                        ...
                        <form onSubmit={handleSubmit} className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                ...
                                <div>
                                    <label className="block text-[10px] font-medium text-slate-400 uppercase tracking-wider mb-2 text-primary">Total Amount Received (₹)</label>
                            ...
                            <table className="table-modern w-full text-left border-collapse min-w-[800px]">
                                <thead>
                                    <tr className="bg-slate-50 border-b border-slate-200 whitespace-nowrap">
                                        ...
                                        <th className="px-6 py-4 text-[10px] font-medium text-slate-500 uppercase tracking-wider text-right w-[15%]">Amount Received</th>
                                            ...
                                            return (
                                                <tr key={v.id} className="hover:bg-slate-50/50 transition-colors group">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <div className="flex flex-col gap-1">
                                                            <div className="flex items-center gap-2">
                                                                <span className="text-[9px] font-medium px-1.5 py-0.5 rounded bg-primary-light text-primary border border-primary-light uppercase tracking-tighter">Debit / In:</span>
                                                                <span className="text-[11px] font-medium text-slate-700">{debitEntry?.ledger?.name || debitEntry?.debitLedger?.name || 'Unknown'}</span>
                                                            </div>
                                                            <div className="flex items-center gap-2">
                                                                <span className="text-[9px] font-medium px-1.5 py-0.5 rounded bg-blue-50 text-blue-600 border border-blue-100 uppercase tracking-tighter">Credit / From:</span>
                                                    ...
                                                    <td className="px-6 py-4 text-right">
                                                        <div className="flex flex-col items-end">
                                                            ...
                                                            {v.status === 'CANCELLED' ? (
                                                                <span className="mt-1 px-1.5 py-0.5 rounded bg-red-100 text-red-600 text-[8px] font-medium uppercase tracking-widest ring-1 ring-red-200">Invalid</span>
                                                            ) : (
                                                                <span className="mt-1 px-1.5 py-0.5 rounded bg-primary-light text-primary text-[8px] font-medium uppercase tracking-widest ring-1 ring-primary/20">Verified</span>
                                                            )}
                                                        </div>
                                                    </td>
                                                    <td className="px-6 py-4">
